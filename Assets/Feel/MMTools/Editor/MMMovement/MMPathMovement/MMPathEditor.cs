	...
	{		
		...
		protected virtual void OnSceneGUI()
		{
			...
			for (int i=0;i<t.PathElements.Count;i++)
			{
				...
				var fmh_49_57_638407914366280785 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint,.5f,new Vector3(.25f,.25f,.25f),Handles.CircleHandleCap);
